...
Status AudioPolicyService::setStreamVolumeIndex(AudioStreamType streamAidl, int32_t uidAidl,
    ...
    audio_utils::lock_guard _l(mMutex);
    AutoCallerClear acc;
    return binderStatusFromStatusT(mAudioPolicyManager->setStreamVolumeIndex(stream, uid, index,
            device));
}
