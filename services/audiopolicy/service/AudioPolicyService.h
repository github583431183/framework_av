...
private:
    ...
    class AudioPolicyClient : public AudioPolicyClientInterface
    {
     public:
        ...
        /**
         * Set a volume on port(s) for a particular output. For the same user setting, a volume group
         * (and associated given port of the client's track) can have different volumes for each output
         * (destination device) it is attached to.
         *
         * @param ports to consider
         * @param volume to set
         * @param output to consider
