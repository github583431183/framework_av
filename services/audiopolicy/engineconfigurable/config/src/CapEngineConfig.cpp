...
struct CapConfigurableDomainTraits : public BaseSerializerTraits<CapConfigurableDomain, CapConfigurableDomains> {
...
struct ConfigurableElementTraits : public BaseSerializerTraits<ConfigurableElement, ConfigurableElements> {
