...
PatchTrackBase::PatchTrackBase(const sp<AudioTrackClientProxy>& proxy,
...
PatchTrack::PatchTrack(IAfPlaybackThread* playbackThread,
    ...
    :   Track(playbackThread, NULL, streamType,
        ...
        PatchTrackBase(mCblk ? new AudioTrackClientProxy(mCblk, mBuffer, frameCount, mFrameSize, true /*clientInServer*/)
                        : nullptr,
                       playbackThread, timeout)
{
    if (mProxy != NULL) {
        mProxy->setPlaybackRate({
                /* .mSpeed = */ speed,
