...
status_t MediaCodec::detachSurface() {
    ...
    switch (msg->what()) {
        ...
        case kWhatConfigure:
        {
            ...
            if (android::media::codec::provider_->null_output_surface_support()) {
                if (obj == nullptr && (flags & CONFIGURE_FLAG_DETACHED_SURFACE)) {
            ...
            if (asyncNotify != nullptr && mSurface != NULL) {
                if (android::media::codec::provider_->null_output_surface_support()) {
                    ...
                    if (mSurface != mDetachedSurface->getSurface()) {
                        uint32_t generation;
                        status_t err = connectToSurface(mDetachedSurface->getSurface(), &generation);
