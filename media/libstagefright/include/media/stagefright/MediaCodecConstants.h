...
constexpr int32_t VVCProfileMain10              = 0x1;
constexpr int32_t VVCProfileMain10Still         = 0x2;
constexpr int32_t VVCProfileMain10444           = 0x4;
constexpr int32_t VVCProfileMain10444Still      = 0x8;
constexpr int32_t VVCProfileMultilayerMain10    = 0x10;
constexpr int32_t VVCProfileMultilayerMain10444 = 0x20;
constexpr int32_t VVCProfileMain12              = 0x40;
constexpr int32_t VVCProfileMain12Intra         = 0x80;
constexpr int32_t VVCProfileMain12Still         = 0x100;
constexpr int32_t VVCProfileMain12444           = 0x200;
constexpr int32_t VVCProfileMain12444Intra      = 0x400;
constexpr int32_t VVCProfileMain12444Still      = 0x800;
constexpr int32_t VVCProfileMain16444           = 0x1000;
constexpr int32_t VVCProfileMain16444Intra      = 0x2000;
constexpr int32_t VVCProfileMain16444Still      = 0x4000;
...
constexpr int32_t VVCMainTierLevel1   = 0x1;
constexpr int32_t VVCMainTierLevel2   = 0x2;
constexpr int32_t VVCMainTierLevel21  = 0x4;
constexpr int32_t VVCMainTierLevel3   = 0x8;
constexpr int32_t VVCMainTierLevel31  = 0x10;
constexpr int32_t VVCMainTierLevel4   = 0x20;
constexpr int32_t VVCHighTierLevel4   = 0x40;
constexpr int32_t VVCMainTierLevel41  = 0x80;
constexpr int32_t VVCHighTierLevel41  = 0x100;
constexpr int32_t VVCMainTierLevel5   = 0x200;
constexpr int32_t VVCHighTierLevel5   = 0x400;
constexpr int32_t VVCMainTierLevel51  = 0x800;
constexpr int32_t VVCHighTierLevel51  = 0x1000;
constexpr int32_t VVCMainTierLevel52  = 0x2000;
constexpr int32_t VVCHighTierLevel52  = 0x4000;
constexpr int32_t VVCMainTierLevel6   = 0x8000;
constexpr int32_t VVCHighTierLevel6   = 0x10000;
constexpr int32_t VVCMainTierLevel61  = 0x20000;
constexpr int32_t VVCHighTierLevel61  = 0x40000;
constexpr int32_t VVCMainTierLevel62  = 0x80000;
constexpr int32_t VVCHighTierLevel62  = 0x100000;
constexpr int32_t VVCMainTierLevel63  = 0x200000;
constexpr int32_t VVCHighTierLevel63  = 0x400000;
