...
private:
    ...
    void profile_tier_level(NALBitReader* br, uint32_t profileTierPresentFlag, int MaxNumSubLayersMinus1);
    void general_constraints_info(NALBitReader* br);
    void dpb_parameters(ABitReader* br, uint32_t MaxSubLayersMinus1, uint32_t subLayerInfoFlag);
    void ref_pic_list_struct(ABitReader* br,
                                uint32_t listIdx,
                                uint32_t rplsIdx,
    ...
    void sublayer_hrd_parameters(ABitReader* br,
                                    uint32_t subLayerId,
