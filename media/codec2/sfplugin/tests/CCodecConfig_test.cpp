        ...
        public:
            Impl(const std::shared_ptr<C2ReflectorHelper> &reflector,
                ...
                if (isEncoder) {
                    ...
                    addParameter(DefineParam(mInputQpOffsetMap, C2_PARAMKEY_QP_OFFSET_MAP)
...
TEST_F(CCodecConfigTest, SetRegionOfInterestParams) {
    ...
    format->setString(PARAMETER_KEY_QP_OFFSET_RECTS,
                      "0,0-16,16=-1;0,16-16,32=0;16,0-32,16=1;16,16-32,32=1;");
    format->setBuffer(PARAMETER_KEY_QP_OFFSET_MAP,
                      ABuffer::CreateAsCopy(mapInfo, sizeof(mapInfo)));
