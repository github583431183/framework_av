 ...
 * 'getObservablePosition'. The first difference is that they may have a
 ...
 *               |            | non-offload  | offload
 * ==============|============|==============|==============
 *  PCM          | Continuous | Continuous   | Reset on
 *               |            |              | flush, drain
 *               |            |              | and standby
 * --------------|------------|--------------|--------------
 *  Bitstream or | Not        | Reset on     | Reset on
 *  compressed   | supported  | flush, drain | flush, drain
 *  wrapped into |            | and standby  | and standby
 *  PCM          |            |              |
 */
