...
TEST(NdkMediaCodec_tests, error_while_configuring_decoder) {
    ...
    ASSERT_NE(nullptr, decoder) << "Codec must not be null";
 ...
 * adb push frameworks/av/media/module/libmediatranscoding/tests/assets/TranscodingTestAssets/plex_hevc_3840x2160_20Mbps.mp4 /data/local/tmp/MediaBenchmark/res/
 *
 *
 * To build the test:
 * =================
 ...
 * adb push $OUT/data/nativetest64/libmediandk_test/libmediandk_test /data/nativetest64/libmediandk_test/
 *
 * To run the test:
 * ================
