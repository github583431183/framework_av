...
int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::align(
...
std::shared_ptr<MediaCodecInfoParser::VideoCapabilities>
        MediaCodecInfoParser::VideoCapabilities::Create(
        const sp<AMessage> &format, CodecCapabilities &parent) {
...
std::vector<MediaCodecInfoParser::VideoCapabilities::PerformancePoint>
        MediaCodecInfoParser::VideoCapabilities::getPerformancePoints(
        const sp<AMessage> &format) const {
...
void MediaCodecInfoParser::VideoCapabilities::applyAlignment(
...
std::shared_ptr<MediaCodecInfoParser::EncoderCapabilities>
        MediaCodecInfoParser::EncoderCapabilities::Create(
        const sp<AMessage> &format, CodecCapabilities &parent) {
...
std::vector<MediaCodecInfo::Feature>
...
std::vector<MediaCodecInfo::ProfileLevel>
