...
std::shared_ptr<MediaCodecInfoParser::CodecCapabilities>
    ...
    std::vector<MediaCodecInfo::ProfileLevel> pls;
    pls.push_back(pl);
...
MediaCodecInfoParser::CodecCapabilities::CodecCapabilities(std::vector<MediaCodecInfo::ProfileLevel> profLevs,
        std::vector<uint32_t> colFmts, bool encoder, sp<AMessage> &defaultFormat,
        sp<AMessage> &capabilitiesInfo, int32_t maxConcurrentInstances) {
    ...
    mMaxSupportedInstances = maxConcurrentInstances > 0 ? maxConcurrentInstances : DEFAULT_MAX_SUPPORTED_INSTANCES;
