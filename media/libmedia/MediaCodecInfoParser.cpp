...
/** 480p 24fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_24
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 480, 24);
/** 576p 25fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_25
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 576, 25);
/** 480p 30fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_30
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 480, 30);
/** 480p 48fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_48
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 480, 48);
/** 576p 50fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_50
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 576, 50);
/** 480p 60fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint SD_60
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(720, 480, 60);

/** 720p 24fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_24
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 24);
/** 720p 25fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_25
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 25);
/** 720p 30fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_30
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 30);
/** 720p 50fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_50
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 50);
/** 720p 60fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_60
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 60);
/** 720p 100fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_100
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 100);
/** 720p 120fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_120
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 120);
/** 720p 200fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_200
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 200);
/** 720p 240fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint HD_240
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1280, 720, 240);

/** 1080p 24fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_24
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 24);
/** 1080p 25fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_25
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 25);
/** 1080p 30fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_30
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 30);
/** 1080p 50fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_50
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 50);
/** 1080p 60fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_60
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 60);
/** 1080p 100fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_100
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 100);
/** 1080p 120fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_120
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 120);
/** 1080p 200fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_200
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 200);
/** 1080p 240fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint FHD_240
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(1920, 1080, 240);

/** 2160p 24fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_24
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 24);
/** 2160p 25fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_25
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 25);
/** 2160p 30fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_30
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 30);
/** 2160p 50fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_50
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 50);
/** 2160p 60fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_60
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 60);
/** 2160p 100fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_100
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 100);
/** 2160p 120fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_120
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 120);
/** 2160p 200fps */
static const MediaCodecInfoParser::VideoCapabilities::PerformancePoint UHD_200
        = MediaCodecInfoParser::VideoCapabilities::PerformancePoint(3840, 2160, 200);
/** 2160p 240fps */
...
static const std::vector<MediaCodecInfo::Feature> DecoderFeatures = {
    MediaCodecInfo::Feature(FEATURE_AdaptivePlayback, (1 << 0), true),
    MediaCodecInfo::Feature(FEATURE_SecurePlayback,   (1 << 1), false),
    MediaCodecInfo::Feature(FEATURE_TunneledPlayback, (1 << 2), false),
    MediaCodecInfo::Feature(FEATURE_PartialFrame,     (1 << 3), false),
    MediaCodecInfo::Feature(FEATURE_FrameParsing,     (1 << 4), false),
    MediaCodecInfo::Feature(FEATURE_MultipleFrames,   (1 << 5), false),
    MediaCodecInfo::Feature(FEATURE_DynamicTimestamp, (1 << 6), false),
    MediaCodecInfo::Feature(FEATURE_LowLatency,       (1 << 7), true),
    // feature to exclude codec from REGULAR codec list
    MediaCodecInfo::Feature(FEATURE_SpecialCodec,     (1 << 30), false, true),
};
static const std::vector<MediaCodecInfo::Feature> EncoderFeatures = {
    MediaCodecInfo::Feature(FEATURE_IntraRefresh, (1 << 0), false),
    MediaCodecInfo::Feature(FEATURE_MultipleFrames, (1 << 1), false),
    MediaCodecInfo::Feature(FEATURE_DynamicTimestamp, (1 << 2), false),
    MediaCodecInfo::Feature(FEATURE_QpBounds, (1 << 3), false),
    MediaCodecInfo::Feature(FEATURE_EncodingStatistics, (1 << 4), false),
    MediaCodecInfo::Feature(FEATURE_HdrEditing, (1 << 5), false),
    // feature to exclude codec from REGULAR codec list
    MediaCodecInfo::Feature(FEATURE_SpecialCodec,     (1 << 30), false, true),
};
...
std::vector<Range<int>> MediaCodecInfoParser::AudioCapabilities::getSupportedSampleRateRanges() const {
...
std::vector<Range<int>> MediaCodecInfoParser::AudioCapabilities::getInputChannelCountRanges() const {
    return mInputChannelRanges;
}

// static
std::shared_ptr<MediaCodecInfoParser::AudioCapabilities> MediaCodecInfoParser::AudioCapabilities::Create(
...
Range<int> MediaCodecInfoParser::VideoCapabilities::getBitrateRange() const {
    return mBitrateRange;
}

Range<int> MediaCodecInfoParser::VideoCapabilities::getSupportedWidths() const {
    return mWidthRange;
}

Range<int> MediaCodecInfoParser::VideoCapabilities::getSupportedHeights() const {
    return mHeightRange;
}

int MediaCodecInfoParser::VideoCapabilities::getWidthAlignment() const {
    return mWidthAlignment;
}

int MediaCodecInfoParser::VideoCapabilities::getHeightAlignment() const {
    return mHeightAlignment;
}

int MediaCodecInfoParser::VideoCapabilities::getSmallerDimensionUpperLimit() const {
    return mSmallerDimensionUpperLimit;
}

Range<int> MediaCodecInfoParser::VideoCapabilities::getSupportedFrameRates() const {
    return mFrameRateRange;
}

Range<int> MediaCodecInfoParser::VideoCapabilities::getSupportedWidthsFor(int height) const {
...
Range<int> MediaCodecInfoParser::VideoCapabilities::getSupportedHeightsFor(int width) const {
...
Range<double> MediaCodecInfoParser::VideoCapabilities::getSupportedFrameRatesFor(
...
int MediaCodecInfoParser::VideoCapabilities::getBlockCount(int width, int height) const {
    return divUp(width, mBlockWidth) * divUp(height, mBlockHeight);
}

std::optional<VideoSize> MediaCodecInfoParser::VideoCapabilities::findClosestSize(
        int width, int height) const {
...
std::optional<Range<double>> MediaCodecInfoParser::VideoCapabilities::estimateFrameRatesFor(
        int width, int height) const {
...
std::optional<Range<double>> MediaCodecInfoParser::VideoCapabilities::getAchievableFrameRatesFor(
        int width, int height) const {
    CHECK(supports(width, height, 0));
...
int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::getMaxMacroBlocks() const {
    return saturateLongToInt(mWidth * (long)mHeight);
}

int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::getMaxFrameRate() const {
    return mMaxFrameRate;
}

long MediaCodecInfoParser::VideoCapabilities::PerformancePoint::getMaxMacroBlockRate() const {
    return mMaxMacroBlockRate;
}

std::string MediaCodecInfoParser::VideoCapabilities::PerformancePoint::toString() const {
...
int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::hashCode() const {
    // only max frame rate must equal between performance points that equal to one
    // another
    return mMaxFrameRate;
}

MediaCodecInfoParser::VideoCapabilities::PerformancePoint::PerformancePoint(
...
int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::saturateLongToInt(long value) const {
    if (value < INT_MIN) {
        return INT_MIN;
...
int MediaCodecInfoParser::VideoCapabilities::PerformancePoint::align(int value, int alignment) const {
    return divUp(value, alignment) * alignment;
}

void MediaCodecInfoParser::VideoCapabilities::PerformancePoint::checkPowerOfTwo2(int value) {
    CHECK(value == 0 || (value & (value - 1)) == 0);
}

bool MediaCodecInfoParser::VideoCapabilities::PerformancePoint::covers(const sp<AMessage> &format) const {
...
bool MediaCodecInfoParser::VideoCapabilities::PerformancePoint::covers(
...
VideoSize MediaCodecInfoParser::VideoCapabilities::PerformancePoint::getCommonBlockSize(
        const PerformancePoint &other) const {
    return VideoSize(
...
bool MediaCodecInfoParser::VideoCapabilities::PerformancePoint::equals(
        const PerformancePoint &other) const {
    // convert performance points to common block size
    VideoSize commonSize = getCommonBlockSize(other);
    PerformancePoint aligned = PerformancePoint(*this, commonSize);
...
std::vector<MediaCodecInfoParser::VideoCapabilities::PerformancePoint>
        MediaCodecInfoParser::VideoCapabilities::getSupportedPerformancePoints() const {
    return mPerformancePoints;
}

bool MediaCodecInfoParser::VideoCapabilities::areSizeAndRateSupported(
        int width, int height, double frameRate) const {
    return supports(width, height, frameRate);
}

bool MediaCodecInfoParser::VideoCapabilities::isSizeSupported(int width, int height) const {
    return supports(width, height, 0);  // Replace null with 0
}

bool MediaCodecInfoParser::VideoCapabilities::supports(int width, int height, double rate) const {
    bool ok = true;
...
bool MediaCodecInfoParser::VideoCapabilities::supportsFormat(const sp<AMessage> &format) const {
...
// static
std::shared_ptr<MediaCodecInfoParser::VideoCapabilities> MediaCodecInfoParser::VideoCapabilities::Create(
        const sp<AMessage> &format, CodecCapabilities &parent) {
...
void MediaCodecInfoParser::VideoCapabilities::init(
        const sp<AMessage> &format, CodecCapabilities &parent) {
    mParent = std::make_shared<CodecCapabilities>(parent);
    initWithPlatformLimits();
    applyLevelLimits();
...
VideoSize MediaCodecInfoParser::VideoCapabilities::getBlockSize() const {
    return VideoSize(mBlockWidth, mBlockHeight);
}

Range<int> MediaCodecInfoParser::VideoCapabilities::getBlockCountRange() const {
    return mBlockCountRange;
}

Range<long> MediaCodecInfoParser::VideoCapabilities::getBlocksPerSecondRange() const {
    return mBlocksPerSecondRange;
}

Range<Rational> MediaCodecInfoParser::VideoCapabilities::getAspectRatioRange(bool blocks) const {
    return blocks ? mBlockAspectRatioRange : mAspectRatioRange;
}

// still in progress
void MediaCodecInfoParser::VideoCapabilities::initWithPlatformLimits() {
...
std::vector<MediaCodecInfoParser::VideoCapabilities::PerformancePoint>
        MediaCodecInfoParser::VideoCapabilities::getPerformancePoints(const sp<AMessage> &format) const {
...
std::map<VideoSize, Range<long>, VideoSizeCompare> MediaCodecInfoParser::VideoCapabilities
...
// static
std::optional<std::pair<Range<int>, Range<int>>> MediaCodecInfoParser::VideoCapabilities
...
// static
int MediaCodecInfoParser::VideoCapabilities::EquivalentVP9Level(const sp<AMessage> &format) {
...
void MediaCodecInfoParser::VideoCapabilities::parseFromInfo(const sp<AMessage> &format) {
...
void MediaCodecInfoParser::VideoCapabilities::applyBlockLimits(
...
void MediaCodecInfoParser::VideoCapabilities::applyAlignment(int widthAlignment, int heightAlignment) {
...
void MediaCodecInfoParser::VideoCapabilities::updateLimits() {
...
void MediaCodecInfoParser::VideoCapabilities::applyMacroBlockLimits(
...
void MediaCodecInfoParser::VideoCapabilities::applyLevelLimits() {
...
Range<int> MediaCodecInfoParser::EncoderCapabilities::getQualityRange() {
    return mQualityRange;
}

Range<int> MediaCodecInfoParser::EncoderCapabilities::getComplexityRange() {
    return mComplexityRange;
}

// static
int MediaCodecInfoParser::EncoderCapabilities::ParseBitrateMode(std::string mode) {
...
bool MediaCodecInfoParser::EncoderCapabilities::isBitrateModeSupported(int mode) {
    for (Feature feat: bitrates) {
        if (mode == feat.mValue) {
...
// static
std::shared_ptr<MediaCodecInfoParser::EncoderCapabilities> MediaCodecInfoParser::EncoderCapabilities::Create(
        const sp<AMessage> &format, CodecCapabilities &parent) {
...
void MediaCodecInfoParser::EncoderCapabilities::init(const sp<AMessage> &format,
        CodecCapabilities &parent) {
...
void MediaCodecInfoParser::EncoderCapabilities::applyLevelLimits() {
    auto lockParent = mParent.lock();
    if (!lockParent) {
        return;
    }
...
void MediaCodecInfoParser::EncoderCapabilities::parseFromInfo(const sp<AMessage> &format) {
...
bool MediaCodecInfoParser::EncoderCapabilities::supports(
...
void MediaCodecInfoParser::EncoderCapabilities::getDefaultFormat(sp<AMessage> &format) {
...
bool MediaCodecInfoParser::EncoderCapabilities::supportsFormat(const sp<AMessage> &format) {
    auto lockParent = mParent.lock();
    if (!lockParent) {
        return false;
    }
...
std::vector<MediaCodecInfo::Feature> MediaCodecInfoParser::CodecCapabilities::getValidFeatures() const {
    if (isEncoder()) {
...
std::vector<MediaCodecInfo::ProfileLevel> MediaCodecInfoParser::CodecCapabilities::getProfileLevels() {
...
std::shared_ptr<MediaCodecInfo::AudioCapabilities>
...
std::shared_ptr<MediaCodecInfo::EncoderCapabilities>
...
std::shared_ptr<MediaCodecInfo::VideoCapabilities>
...
std::shared_ptr<MediaCodecInfoParser::CodecCapabilities>
        ...
        AString mediaType, int profile, int level) {
    ProfileLevel pl;
    pl.mProfile = profile;
    pl.mLevel = level;
    ...
    std::shared_ptr<CodecCapabilities> ret(new CodecCapabilities(pls, colFmts, true /* encoder */,
            defaultFormat, capabilitiesInfo));
    if (ret->mError != 0) {
        return nullptr;
    }
    return ret;
...
MediaCodecInfoParser::CodecCapabilities::CodecCapabilities(
        std::vector<MediaCodecInfo::ProfileLevel> profLevs, std::vector<uint32_t> colFmts,
