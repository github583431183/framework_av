...
struct MediaCodecInfoParser : public RefBase {
    ...
    struct CodecCapabilities {
        ...
        static std::shared_ptr<CodecCapabilities>
                CreateFromProfileLevel(AString mediaType, int profile, int level);
    ...
    private:
        ...
        CodecCapabilities(std::vector<MediaCodecInfo::ProfileLevel> profLevs, std::vector<uint32_t> colFmts,
