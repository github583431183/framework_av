...
struct MediaCodecInfoParser : public RefBase {
    ...
    struct CodecCapabilities {
         ...
         */
        static std::shared_ptr<CodecCapabilities>
                CreateFromProfileLevel(AString mediaType, int profile, int level, int32_t maxConcurrentInstances = -1);
        ...
        std::vector<MediaCodecInfo::ProfileLevel> getProfileLevels();
    ...
    private:
        AString mMediaType;
        std::vector<MediaCodecInfo::ProfileLevel> mProfileLevels;
        ...
        CodecCapabilities(std::vector<MediaCodecInfo::ProfileLevel> profLevs,
