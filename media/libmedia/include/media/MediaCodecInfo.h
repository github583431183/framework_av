...
struct MediaCodecInfo : public RefBase {
    ...
    const std::shared_ptr<CodecCaps> getCodecCapsFor(const char *mediaType) const;
...
private:
    ...
    KeyedVector<AString, std::shared_ptr<CodecCaps>> mCodecCaps;
...
struct MediaCodecInfoWriter {
    ...
    void setCodecCapsMap();

    std::shared_ptr<CodecCaps> getCodecCapsFromCaps(
