...
std::optional<Range<int>> VideoCapabilities::getSupportedWidthsFor(int height) const {
...
std::optional<Range<int>> VideoCapabilities::getSupportedHeightsFor(int width) const {
