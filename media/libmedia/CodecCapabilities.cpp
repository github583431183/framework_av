...
void XCapabilitiesBase::setParentError(int error) {
...
Range<int> AudioCapabilities::getBitrateRange() const {
    return mBitrateRange;
}

std::vector<int> AudioCapabilities::getSupportedSampleRates() const {
    return mSampleRates;
}
...
Vector<MediaCodecInfo::ProfileLevel> CodecCapabilities::getProfileLevels() {
